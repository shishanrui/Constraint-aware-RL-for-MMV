...
def start_tensorboard(logdir: Path, port: int = 6017) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--w-invalid-request", type=float, default=None, help="Unified penalty for a shield-corrected invalid request.")
    ...
    parser.add_argument("--tb-port", type=int, default=6017, help="TensorBoard port.")
    ...
    print("[TRAIN] training_constraint_mode=full_post_sampling_shield")
    print("[TRAIN] train_invalid_nv_fallback=off")
    ...
    manifest = {
        "experiment": "flat_fullshield_v2",
        "training_constraint_mode": "full_post_sampling_shield",
        "train_invalid_nv_fallback": "off",
        "model_name": model_name,
        "config": asdict(cfg),
    }
