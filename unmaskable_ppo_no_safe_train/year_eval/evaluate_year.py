...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="occupied_ac",
        help="Eval-only fallback for invalid NV overrides. Default 'occupied_ac' uses AC when occupied; 'off' is the diagnostic fallback.",
    )
    parser.add_argument(
        "--fallback-ac-sp-c",
        type=float,
        default=29.0,
        help="AC setpoint in C used by --invalid-nv-fallback occupied_ac.",
    )
